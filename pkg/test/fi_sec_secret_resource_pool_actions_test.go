...
func TestCreateFiSecSecretResourcePool(t *testing.T) {
	// WARNING: This test will create a real resource!
	t.Skip("TestCreateFiSecSecretResourcePool is skipped by default. Implement with valid params to test creation.")

	// createParam := param.CreateFiSecSecretResourcePoolParam{
	// 	BaseParam: param.BaseParam{},
	// 	Params: param.CreateFiSecSecretResourcePoolParamDetail{
	// 		Name: "test-fisecsecretresourcepool",
