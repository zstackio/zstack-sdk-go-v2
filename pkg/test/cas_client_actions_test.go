...
func TestCreateCasClient(t *testing.T) {
	// WARNING: This test will create a real resource!
	t.Skip("TestCreateCasClient is skipped by default. Implement with valid params to test creation.")

	// createParam := param.CreateCasClientParam{
	// 	BaseParam: param.BaseParam{},
	// 	Params: param.CreateCasClientParamDetail{
	// 		Name: "test-casclient",
