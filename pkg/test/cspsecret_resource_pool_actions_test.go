...
func TestCreateCSPSecretResourcePool(t *testing.T) {
	// WARNING: This test will create a real resource!
	t.Skip("TestCreateCSPSecretResourcePool is skipped by default. Implement with valid params to test creation.")

	// createParam := param.CreateCSPSecretResourcePoolParam{
	// 	BaseParam: param.BaseParam{},
	// 	Params: param.CreateCSPSecretResourcePoolParamDetail{
	// 		Name: "test-cspsecretresourcepool",
