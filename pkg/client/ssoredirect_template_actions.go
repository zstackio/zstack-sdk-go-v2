...
func (cli *ZSClient) UpdateSSORedirectTemplate(params param.UpdateSSORedirectTemplateParam) (*view.SSORedirectTemplateInventoryView, error) {
	resp := view.SSORedirectTemplateInventoryView{}
	if err := cli.Post("v1/update/sso/redirectTemplate", params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
