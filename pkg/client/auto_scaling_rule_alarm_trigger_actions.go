...
func (cli *ZSClient) CreateAutoScalingRuleAlarmTrigger(ctx context.Context, alarmUuid string, ruleUuid string, params param.CreateAutoScalingRuleAlarmTriggerParam) (*view.AutoScalingRuleTriggerInventoryView, error) {
