...
func (cli *ZSClient) CreateFlowCollector(flowMeterUuid string, params param.CreateFlowCollectorParam) (*view.FlowCollectorInventoryView, error) {
	resp := view.FlowCollectorInventoryView{}
	if err := cli.Post(fmt.Sprintf("v1/flowmeters/%s/collectors", flowMeterUuid), params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
