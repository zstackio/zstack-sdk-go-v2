...
func (cli *ZSClient) AddAccessControlListEntry(aclUuid string, params param.AddAccessControlListEntryParam) (*view.AccessControlListEntryInventoryView, error) {
	resp := view.AccessControlListEntryInventoryView{}
	if err := cli.Post(fmt.Sprintf("v1/access-control-lists/%s/ipentries", aclUuid), params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
