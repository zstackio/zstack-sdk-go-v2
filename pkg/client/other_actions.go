...
func (cli *ZSClient) SetVmInstanceHygonMdev(ctx context.Context, params param.SetVmInstanceHygonMdevParam) (*view.SetVmInstanceHygonMdevEventView, error) {
	resp := view.SetVmInstanceHygonMdevEventView{}
	if err := cli.Post(ctx, "v1/vm-instances/{uuid}/hygon-mdev", params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (cli *ZSClient) DeleteCdpTaskData(ctx context.Context, params param.DeleteCdpTaskDataParam) (*view.DeleteCdpTaskDataEventView, error) {
	...
	if err := cli.Post(ctx, "v1/cdp-task/{uuid}/data", params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (cli *ZSClient) AddL3NetworkToGroup(ctx context.Context, params param.AddL3NetworkToGroupParam) (*view.AddL3NetworkToGroupEventView, error) {
	resp := view.AddL3NetworkToGroupEventView{}
	if err := cli.Post(ctx, "v1/nfvinstgroup/group/{nfvInstGroupUuid}/service/{networkServiceUuid}", params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (cli *ZSClient) CreateBareMetal2InstanceFromVolumeBackup(ctx context.Context, params param.CreateBareMetal2InstanceFromVolumeBackupParam) (*view.BareMetal2InstanceInventoryView, error) {
	resp := view.BareMetal2InstanceInventoryView{}
	if err := cli.Post(ctx, "v1/baremetal2-instance/from/volume-backup/{backupUuid}", params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (cli *ZSClient) CreateBareMetal2InstanceFromVmBackup(ctx context.Context, params param.CreateBareMetal2InstanceFromVmBackupParam) (*view.BareMetal2InstanceInventoryView, error) {
	resp := view.BareMetal2InstanceInventoryView{}
	if err := cli.Post(ctx, "v1/baremetal2-instance/from/vm-backup/{groupUuid}", params, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
