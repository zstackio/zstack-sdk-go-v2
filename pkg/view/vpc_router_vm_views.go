...
type VpcRouterVmInventoryView struct {
	rest []VpcRouterDnsInventoryView `json:"dns,omitempty"`
	rest []VpcHaGroupApplianceVmRefInventoryView `json:"haRef,omitempty"`
	rest string `json:"publicNetworkUuid,omitempty"`
	rest []string `json:"virtualRouterVips,omitempty"`
	...
	rest int `json:"agentPort,omitempty"`
	rest string `json:"haStatus,omitempty"`
