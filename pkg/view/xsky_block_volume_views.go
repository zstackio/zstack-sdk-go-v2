...
type XskyBlockVolumeInventoryView struct {
	rest int `json:"accessPathId,omitempty"`
	rest string `json:"accessPathIqn,omitempty"`
	rest string `json:"xskyStatus,omitempty"`
	rest int `json:"xskyBlockVolumeId,omitempty"`
