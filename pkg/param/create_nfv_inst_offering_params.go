...
// CreateNfvInstOfferingDetailParam CreateNfvInstOffering detail param
type CreateNfvInstOfferingDetailParam struct {
...
type CreateNfvInstOfferingParam struct {
	BaseParam
	Params CreateNfvInstOfferingDetailParam `json:"params"`
}
