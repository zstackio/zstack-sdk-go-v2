...
type DeleteIAM2OrganizationParam struct {
	BaseParam
	Params DeleteIAM2OrganizationParamDetail `json:"deleteIAM2Organization"`
}
...
type UpdateIAM2OrganizationParam struct {
	BaseParam
	Params UpdateIAM2OrganizationParamDetail `json:"updateIAM2Organization"`
}
...
type CreateIAM2OrganizationParam struct {
	BaseParam
	Params CreateIAM2OrganizationParamDetail `json:"createIAM2Organization"`
}
