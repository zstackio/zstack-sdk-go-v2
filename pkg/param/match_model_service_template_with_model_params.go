...
// MatchModelServiceTemplateWithModelDetailParam MatchModelServiceTemplateWithModel详细参数
type MatchModelServiceTemplateWithModelDetailParam struct {
	rest []string `json:"modelUuids" validate:"required"` // 必填
	rest []string `json:"modelServiceUuids" validate:"required"` // 必填
	rest int `json:"instanceNumber" validate:"required"` // 必填
...
// MatchModelServiceTemplateWithModelParam MatchModelServiceTemplateWithModel请求参数
type MatchModelServiceTemplateWithModelParam struct {
	BaseParam
	Params MatchModelServiceTemplateWithModelDetailParam `json:"params"` // 详细参数
}
