...
// MatchModelServiceTemplateWithModelDetailParam MatchModelServiceTemplateWithModel detail param
...
type MatchModelServiceTemplateWithModelParam struct {
	BaseParam
	Params MatchModelServiceTemplateWithModelDetailParam `json:"params"`
}
