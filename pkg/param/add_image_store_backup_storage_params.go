...
// AddImageStoreBackupStorageDetailParam AddImageStoreBackupStorage详细参数
...
// AddImageStoreBackupStorageParam AddImageStoreBackupStorage请求参数
type AddImageStoreBackupStorageParam struct {
	BaseParam
	Params AddImageStoreBackupStorageDetailParam `json:"params"` // 详细参数
}
