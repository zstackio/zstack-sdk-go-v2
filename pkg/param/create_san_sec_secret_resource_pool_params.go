...
// CreateSanSecSecretResourcePoolDetailParam CreateSanSecSecretResourcePool detail param
type CreateSanSecSecretResourcePoolDetailParam struct {
...
type CreateSanSecSecretResourcePoolParam struct {
	BaseParam
	Params CreateSanSecSecretResourcePoolDetailParam `json:"params"`
}
