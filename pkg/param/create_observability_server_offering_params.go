...
// CreateObservabilityServerOfferingDetailParam CreateObservabilityServerOffering detail param
...
type CreateObservabilityServerOfferingParam struct {
	BaseParam
	Params CreateObservabilityServerOfferingDetailParam `json:"params"`
}
