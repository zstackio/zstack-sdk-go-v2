...
type UpdateBareMetal2ProvisionNetworkParam struct {
	BaseParam
	Params UpdateBareMetal2ProvisionNetworkParamDetail `json:"updateBareMetal2ProvisionNetwork"`
}
...
type CreateBareMetal2ProvisionNetworkParam struct {
	BaseParam
	Params CreateBareMetal2ProvisionNetworkParamDetail `json:"createBareMetal2ProvisionNetwork"`
}
...
type DeleteBareMetal2ProvisionNetworkParam struct {
	BaseParam
	Params DeleteBareMetal2ProvisionNetworkParamDetail `json:"deleteBareMetal2ProvisionNetwork"`
}
