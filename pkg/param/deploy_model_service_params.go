...
// DeployModelServiceDetailParam DeployModelService详细参数
...
// DeployModelServiceParam DeployModelService请求参数
type DeployModelServiceParam struct {
	BaseParam
	Params DeployModelServiceDetailParam `json:"params"` // 详细参数
}
